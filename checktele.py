...
꩜ 𝖡𝖸𝖪𝖠 ↬  {trys}
𝚋𝚢 ⤷ @o_z_g ''')
                    await event.client.send_message("@o_z_g", f'''(@{username})
꩜ 𝖡𝖸𝖪𝖠 ↬  {trys}
𝚋𝚢 ⤷ @o_z_g ''')
    ...
    {str(eee)}''')
                    if "A wait of" in str(eee):
                        ...
                        await sython.send_message(event.chat.id, "ᤑ اجاك متاح  \n[heroo](https://t.me/o_z_g)"")
            else:
                pass
            trys += 1
        ...
        isclaim.append("off")
        trys = ""
        await event.client.send_message(event.chat_id, "ᤑ انتهى الصيد  \n[heroo](tg://openmessage?user_id=5586079401)") 
